...
def preflight_check(config):
    ...
    preflight_local_path = os.path.dirname(os.path.realpath(__file__)) + '/preflight.sh'
    ...
    handle_command(lambda: pf.copy_cmd(preflight_local_path, preflight_remote_path))
