...
def make_template(num_masters, gen_arguments, varietal, bootstrap_variant_prefix):
    ...
    if varietal == 'dcos':
        ...
        args['cluster_id'] = "[[[resourceid('Microsoft.Resources/deployments', deployment().name)]]]"
        ...
        # Set cluster_id to nameSuffix, a random 32bit integer controlled by the ACS service. We use this instead of
        # deployment().name at the request of the Azure team (they want templates generated by ACS to be deterministic).
        args['cluster_id'] = "[[[variables('nameSuffix')]]]"
