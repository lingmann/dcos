...
#
# Metadata:
#   dcos image commit: deadbeef
#   generation date: 2016-01-23 16:30:55.736506
#
...
BOOTSTRAP_ID=e2ade83b3197150980714635c6752bc9ece1e0ca
...
["dcos-config--setup_01c1455f51022d41e27b056777b0647dd3c5c367", "dcos-detect-ip--setup_01c1455f51022d41e27b056777b0647dd3c5c367", "dcos-metadata--setup_01c1455f51022d41e27b056777b0647dd3c5c367"]
...
StandardOutput=journal+console
StandardError=journal+console
ExecStartPre=/usr/bin/curl --fail --retry 20 --continue-at - --location --silent --show-error --verbose --output /tmp/bootstrap.tar.xz file:///opt/dcos_install_tmp/bootstrap/${BOOTSTRAP_ID}.bootstrap.tar.xz
